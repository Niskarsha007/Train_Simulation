...
class ShortRight(pygame.sprite.Sprite):
    ...
    def __init__(self, screen, currentID, previousID, nextID, branch):
        super(ShortRight, self).__init__()
    ...
    def drawTrack(self, x, y, compass, screen, trackColour=(255, 128, 0)):
        ...
        if compass == "N":
            ...
            pygame.draw.arc(screen, trackColour, [
                            x, y-75, 150, 150], 3*math.pi/4, math.pi, 5)
            ...
            pygame.draw.arc(screen, trackColour, [
                            x-(75-trueCoordinate), y-(75-trueCoordinate), 150, 150], math.pi/2, 3*math.pi/4, 5)
            setCoordinates(self, x, y)
            x = x + trueCoordinate
            ...
            pygame.draw.arc(screen, trackColour, [
                            x-75, y, 150, 150], math.pi/4, math.pi/2, 5)
            setCoordinates(self, x, y)
            x = x + (trueCoordinate)
            y = y + (75 - trueCoordinate)
            return x, y
            ...
            pygame.draw.arc(screen, trackColour, [
                            x-(75+trueCoordinate), y-(75-trueCoordinate), 150, 150], 2*math.pi, math.pi/4, 5)
            setCoordinates(self, x, y)
            x = x + (75 - trueCoordinate)
            y = y + trueCoordinate
            return x, y
            ...
            pygame.draw.arc(screen, trackColour, [
                            x-150, y-75, 150, 150], 7*math.pi/4, 2*math.pi, 5)
            setCoordinates(self, x, y)
            x = x - (75 - trueCoordinate)
            y = y + trueCoordinate
            return x, y
            ...
            pygame.draw.arc(screen, trackColour, [
                            x-(75 + trueCoordinate), y-(75 + trueCoordinate), 150, 150], 3*math.pi/2, 7*math.pi/4, 5)
            setCoordinates(self, x, y)
            x = x - trueCoordinate
            y = y + (75 - trueCoordinate)
            return x, y
            ...
            pygame.draw.arc(screen, trackColour, [
                            x-75, y-150, 150, 150], 5*math.pi/4, 3*math.pi/2, 5)
            setCoordinates(self, x, y)
            x = x - trueCoordinate
            y = y - (75 - trueCoordinate)
            return x, y
            ...
            pygame.draw.arc(screen, trackColour, [
                            x-(75-trueCoordinate), y-(75+trueCoordinate), 150, 150], math.pi, 5*math.pi/4, 5)
            setCoordinates(self, x, y)
            x = x - (75 - trueCoordinate)
            y = y - trueCoordinate
            return x, y
